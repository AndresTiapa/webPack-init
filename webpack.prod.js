...
module.exports = {
    ...
    module: {
        ...
        rules: [
            ...
            // en prod se descarga el paquete npm i -D css-minimizer-webpack-plugin terser-webpack-plugin
            {
                test: /style\.css$/,
                use: [
    ...
    plugins: [
        ...
        new MiniCssExtractPlugin({
            filename: '[name].[fullhash].css', // filename: 'styles.[fullhash].css',
            ignoreOrder: false
        }),
